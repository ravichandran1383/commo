	...
	function electro_template_loop_availability() {
		...
		if ( ! empty( $availability[ 'availability'] ) ) : ?>
			...
			<div class="availability">
				<?php echo esc_html__( 'Availablity:', 'electro' );?> <span class="electro-stock-availability"><p class="stock <?php echo esc_attr( $availability['class'] ); ?>"><?php echo esc_html( $availability['availability'] ); ?></p></span>
			</div>
